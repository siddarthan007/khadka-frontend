...
<SEO
	title="Set New Password - Khadka Foods"
	description="Set a new password for your Khadka Foods account."
	keywords={['reset password', 'new password', 'change password', 'Khadka Foods']}
