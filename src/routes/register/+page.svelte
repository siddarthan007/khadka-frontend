	...
	<div class="container mx-auto max-w-md px-4 sm:px-6 lg:px-8">
		...
		>
			<div class="card-body space-y-5 p-6 sm:p-8">
				...
				<Button
					class="btn btn-neutral w-full rounded-xl hover:border-base-content hover:bg-base-content hover:text-base-100 transition-all duration-300 shadow-md hover:shadow-lg"
					type="button"
